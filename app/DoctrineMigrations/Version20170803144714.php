 ...
 */
class Version20170803144714 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, payment_instruction_id INT DEFAULT NULL, amount NUMERIC(10, 5) NOT NULL, UNIQUE INDEX UNIQ_E52FFDEE8789B572 (payment_instruction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
