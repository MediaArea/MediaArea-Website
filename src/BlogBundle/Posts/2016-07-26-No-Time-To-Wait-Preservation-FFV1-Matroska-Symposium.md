...
[No Time to Wait!: Standardizing FFV1 & Matroska for Preservation](https://mediaarea.net/MediaConch/NoTimeToWait) was a symposium intentionally overlapping with [Internet Engineering Task Force](https://www.ietf.org)’s 96th meeting, held in Berlin. No Time To Wait! was held on 18-20 July, 2016 and hosted by [Deutsche Kinemathek](https://www.deutsche-kinemathek.de/), [Zuse Institute Berlin](http://www.zib.de/), and [MediaArea](https://mediaarea.net/MediaInfo). The symposium was designed to bring together audiovisual archivists and audiovisual format designers with a focus on the standardization of a preservation-grade audiovisual file format combination package. The structure of this symposium was contingent heavily on the [CELLAR working group](https://datatracker.ietf.org/wg/cellar/charter/) and the initial meeting of this working group at IETF and first rounds of RFCs submitted to the organization.
