...
var importPolicy = (function() {
    var success = function(data, button) {
        button.fadeOut(200).replaceWith('<div class="alert alert-success alert-modal-create-policy" role="alert"><span class="glyphicon glyphicon-ok text-success" aria-hidden="true"></span> <a href="' + Routing.generate('mco_policy_tree') + '" target="_blank" title="View the new policy" class="alert-link">Policy</a> successfuly added</div>');
    }
...
var unpublishPolicy = (function () {
    var success = function(button) {
        ...
        button.hide().after('<div class="alert alert-success alert-modal-create-policy" role="alert"><span class="glyphicon glyphicon-ok text-success" aria-hidden="true"></span> <a href="' + Routing.generate('mco_policy_tree') + '" target="_blank" title="View the new policy" class="alert-link">Policy</a> successfuly unpublished</div>');
    }
