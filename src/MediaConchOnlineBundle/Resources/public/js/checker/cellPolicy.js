var policyCell = (function() {
    ...
    var success = function(data, fileId) {
        ...
        policyResultText += '<span title="' + nodeCell.data('policyName') + '">' + textUtils.truncate(nodeCell.data('policyName'), 45) + '</span>';
    ...
    var policyModal = function(fileId) {
        ...
        nodePolicy.find('.policy-view').on('click', function(e) {
            ...
            if (!$('#modalPolicy-' + fileId).length) {
                ...
                $('#modalPolicy-' + fileId + ' .policy-dld').on('click', function(e) {
                    ...
                    if (modalPolicy) {
                        window.location = checkerAjax.downloadPolicyReportUrl(fileId, modalPolicy, modalDisplay);
                    }
                });
        ...
        nodePolicy.find('.policy-dld').on('click', function(e) {
            ...
            window.location = checkerAjax.downloadPolicyReportUrl(fileId, nodeDld.data('policy'), nodeDld.data('display'));
        });
    };
